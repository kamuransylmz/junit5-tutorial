...
public class ParameterizedTests {
    ...
    @ParameterizedTest
    @CsvSource(value = {"steve,rogers","captain,marvel","buck,barnes"})
    void csvSource_StringString(String param1, String param2){
        System.out.println("param1 = " + param1 + ", param2 = " + param2);
    }

    @ParameterizedTest
    @CsvSource(value = {"steve,32,true", "captain,21,false","buck,5,true"})
    ...
    @ParameterizedTest
    @CsvSource(value = {"steve?rogers","buck?barnes"}, delimiter = '?')
